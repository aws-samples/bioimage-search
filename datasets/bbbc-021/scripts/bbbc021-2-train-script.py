...
class Net(nn.Module): 
    def __init__(self):
        ...
        self.eps=1e-6
        self.a_1 = nn.Parameter(torch.ones(1024))
        self.b_1 = nn.Parameter(torch.zeros(1024))
        self.a_2 = nn.Parameter(torch.ones(512))
        self.b_2 = nn.Parameter(torch.zeros(512))

        # 128
        self.conv1 = nn.Conv2d(channels, 64, 3, stride=2)
        # 63
        ...
        self.conv4 = nn.Conv2d(256, 512, 2, stride=2)
        # 7
        self.dc4 = nn.Dropout2d(0.05)
        self.conv5 = nn.Conv2d(512, 512, 2, stride=2)
        # 3
        self.dc5 = nn.Dropout2d(0.05)
        self.conv6 = nn.Conv2d(512, 2048, 3, stride=1)
        # 1
        self.d1 = nn.Dropout2d(0.15)
        self.fc1 = nn.Linear(2048, 1024)
        # 1
        self.d2 = nn.Dropout2d(0.15)
    ...
    def forward(self, x):
        ...
        x = self.a_1 * (x - mean) / (std + self.eps) + self.b_1
